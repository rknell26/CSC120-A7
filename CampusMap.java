...
public class CampusMap {
    ...
    public static void main(String[] args) {
        ...
        myMap.addBuilding(new Building("Chase House", "45 Elm Street Northampton, MA 01063", 3));
        ...
        myMap.addBuilding(new Building("Lyman Conservatory", "16 College Ln, Northampton, MA 01063", 1));
        myMap.addBuilding(new Building("The Crew House", "College Ln, Northampton, MA 01063", 1));
        myMap.addBuilding(new Building("Smith College Museum of Art", "20 Elm St, Northampton, MA 01063", 3));
        myMap.addBuilding(new Building("Campus Cafe", "100 Elm Street Northampton, MA 01063", 1));
